...
export const partnerships = {
  ...
  host: {
    ...
    /**
     * Racheli's own voice, first person. Only verified facts from the material
     * she supplied — no family details and no numbers she has not confirmed.
     * See CLAUDE.md.
     */
    body: [
      "התחלתי בגיל 20 בלי רקע ובלי עורף פיננסי, עברתי פשיטת רגל, ומשם בניתי הכול מחדש.",
      "היום אני מנהלת 3 עסקים שמכניסים 6 ספרות בחודש — בארבעה ימי עבודה בשבוע, תוך כדי טיולים בעולם.",
      "בדרך לימדתי למעלה מ-1,000 בעלי עסקים ומשפחות איך לבנות עסק שצומח מבפנים החוצה. את רשת הקשרים שהחזיקה את הצמיחה הזאת בניתי בעצמי, מאפס — וזה בדיוק מה שאני מלמדת בהדרכה.",
    ],
    stats: [
