...
const docs = {
  terms: {
    ...
    sections: [
      ...
      {
        h: "המוצרים והשירותים",
        p: "האתר מציע תוכניות ליווי, מנוי למועדון, קורסים דיגיטליים, כנסים וספרים. תיאור מלא של כל מוצר, לרבות היקפו ומה שכלול בו, מופיע בעמוד המוצר.",
      },
      {
        h: "תשלומים",
      ...
      {
        h: "מנויים מתחדשים",
        p: "מנוי למועדון מתחדש אוטומטית בתום כל תקופת חיוב, אלא אם בוטל קודם לכן. ניתן לבטל בכל עת, והביטול ייכנס לתוקף בתום תקופת החיוב הנוכחית.",
      },
      {
        h: "ביטול עסקה",
  ...
  return (
    <article className="px-5 pt-36 pb-24 sm:px-8">
      <div className="mx-auto w-full max-w-3xl">
        <h1 className="font-display text-4xl font-black text-mist sm:text-5xl">
          {entry.title}
        </h1>
        ...
        <div className="mt-12 flex flex-col gap-10">
          {entry.sections.map((section) => (
            <section key={section.h}>
              ...
              <p className="mt-3 leading-relaxed text-mist/65">{section.p}</p>
            </section>
          ))}
        </div>

        <p className="mt-16 rounded-2xl border border-gold/20 bg-void/50 px-5 py-4 text-sm text-mist/45">
