  ...
  return (
    <div className="flex min-h-[80vh] items-center px-5 pt-32 pb-20 sm:px-8">
      <div className="mx-auto w-full max-w-2xl text-center">
        <span className="mx-auto grid size-24 place-items-center rounded-full border border-rose/35 bg-rose/10">
          <XCircle className="size-12 text-rose" aria-hidden="true" />
        </span>
